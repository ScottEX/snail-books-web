...
export default function ExpenseScreen({ onReconHistory, onExpenseHistory }: { onReconHistory?: () => void; onExpenseHistory?: () => void }) {
  ...
  const tabCards = useMemo(() => [
    ...
    { gradient: [withAlpha('#86E3CE', 0.22), withAlpha('#FFDD94', 0.22)], gradientActive: [withAlpha('#86E3CE', 0.48), withAlpha('#FFDD94', 0.48)], title: t('tabExpense'), stat: businessSummary.cumulative_expense || 0, statFmt: fmt(businessSummary.cumulative_expense || 0), statColor: colors.textMain, prefix: '' },
                ...
                {i === 1 && (
                  <View style={{ transform: [{ translateY: -4 }] }}>
                    ...
                    <View style={{ flexDirection: 'row', gap: 8 }}>
                      <View style={{
                        flex: 1, backgroundColor: withAlpha('#86E3CE', 0.22),
                        borderRadius: 10, padding: 10, gap: 4,
                        borderWidth: 0.5, borderColor: withAlpha('#86E3CE', 0.35),
                      ...
                      <View style={{
                        flex: 1, backgroundColor: withAlpha('#FFDD94', 0.22),
                        borderRadius: 10, padding: 10, gap: 4,
                        borderWidth: 0.5, borderColor: withAlpha('#FFDD94', 0.35),
