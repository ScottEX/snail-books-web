...
export default function ReconHistoryScreen({ onBack }: { onBack: () => void }) {
  ...
  const onTouchEnd = (e: any) => {
    ...
    // Swipe right from left edge, horizontal dominant
...
const st = StyleSheet.create({
  ...
  backFloatArrow: {
    fontSize: 22, fontWeight: '400', color: '#8B1E22',
  ...
  loadMoreText: { fontSize: 14, fontWeight: '500', color: '#6B7280' },
  /* ── Empty state ── */
  emptyWrap: {
    marginTop: 80, alignItems: 'center', gap: 12,
  },
  emptyIcon: {
