    ...
    <TouchableOpacity key={r.id} style={st.card} onPress={() => setSelected(r)} activeOpacity={0.7}>
      ...
      <View style={st.cardPairRow}>
        ...
        <View style={st.cardPairCol}>
          ...
          <View style={st.cardPairItem}>
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4 }}><Svg width={18} height={18} viewBox="0 0 24 24" fill="none" stroke={colors.textSub} strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" style={{ transform: [{ translateY: -4 }] }}><Rect x="2" y="4" width="20" height="16" rx="2"/><Path d="M2 10h20"/><Rect x="5" y="14" width="3" height="2" rx="0.5"/></Svg><Text style={st.cardPairLabel}>{t('cardBalance')}</Text></View>
        ...
        <View style={st.cardPairCol}>
          ...
          <View style={st.cardPairDiv} />
          <View style={st.cardPairItem}>
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4 }}><Svg width={18} height={18} viewBox="0 0 24 24" fill="none" stroke={colors.textSub} strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" style={{ transform: [{ translateY: -4 }] }}><Rect x="2" y="5" width="20" height="14" rx="2"/><Circle cx="12" cy="12" r="2.5"/><Path d="M18.5 9l-1 0M18.5 15l-1 0M5.5 9l1 0M5.5 15l1 0"/></Svg><Text style={st.cardPairLabel}>{t('cashBalance')}</Text></View>
        ...
        <View style={st.modal}>
          ...
          <View style={st.pairRow}>
            ...
            <View style={st.pairCol}>
              ...
              <View style={st.pairItem}>
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4 }}><Svg width={18} height={18} viewBox="0 0 24 24" fill="none" stroke={colors.textSub} strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" style={{ transform: [{ translateY: -4 }] }}><Rect x="2" y="4" width="20" height="16" rx="2"/><Path d="M2 10h20"/><Rect x="5" y="14" width="3" height="2" rx="0.5"/></Svg><Text style={st.pairLabel}>{t('cardBalance')}</Text></View>
            ...
            <View style={st.pairCol}>
              ...
              <View style={st.pairDivider} />
              <View style={st.pairItem}>
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4 }}><Svg width={18} height={18} viewBox="0 0 24 24" fill="none" stroke={colors.textSub} strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" style={{ transform: [{ translateY: -4 }] }}><Rect x="2" y="5" width="20" height="14" rx="2"/><Circle cx="12" cy="12" r="2.5"/><Path d="M18.5 9l-1 0M18.5 15l-1 0M5.5 9l1 0M5.5 15l1 0"/></Svg><Text style={st.pairLabel}>{t('cashBalance')}</Text></View>
