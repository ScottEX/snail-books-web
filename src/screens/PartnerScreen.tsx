...
const getS = (colors: ThemeColors) => StyleSheet.create({
  ...
  partnerName: { fontSize: FONTS.sub.size, fontWeight: '700', color: colors.textSub },
...
const getMoBody = (colors: ThemeColors) => StyleSheet.create({
  ...
  input: { width: '100%', backgroundColor: colors.bg, borderWidth: 1, borderColor: 'transparent', borderRadius: 12, paddingVertical: 12, paddingHorizontal: 12, fontSize: FONTS.micro.size, fontWeight: '700' as any, color: colors.textSub, fontFamily: undefined },
...
const getOrg = (colors: ThemeColors) => StyleSheet.create({
  ...
  nodeName: { fontSize: FONTS.sub.size, fontWeight: '700', color: colors.textSub },
...
const getTg = (colors: ThemeColors) => StyleSheet.create({
  ...
  thTitle: { fontSize: FONTS.micro.size, fontWeight: '600', color: colors.textSub },
