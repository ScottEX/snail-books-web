...
export default function InvoiceModal({ visible, onClose }: Props) {
  ...
  return (
    ...
    >
      <View style={[{ backgroundColor: c.surface, borderTopLeftRadius: 24, borderTopRightRadius: 24, width: '100%', maxWidth: CONTENT_MAX_WIDTH, marginLeft: 'auto', marginRight: 'auto', overflow: 'hidden' as any, display: 'flex' as any, flexDirection: 'column' as any }]}>
