...
import { BACKDROP_COLOR, CONTENT_MAX_WIDTH } from '../theme';
...
export default function ModalOverlay({ visible = true, onClose, onClosed, children, overlayStyle, contentStyle, animation = 'slide', staggerCount = 4, backdropColor = BACKDROP_COLOR }: ModalOverlayProps) {
  ...
  return createPortal(
    <Animated.View style={[{ position: 'absolute' as any, top: 0, left: 0, right: 0, bottom: 0, zIndex: 999, justifyContent: 'center', alignItems: 'center', padding: 16, maxWidth: CONTENT_MAX_WIDTH, marginLeft: 'auto' as any, marginRight: 'auto' as any }, overlayStyle]}> 
