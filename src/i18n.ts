const I18N: Record<string, Record<string, string>> = {
  'zh-CN': {
    ...
    langTw: '繁體中文',
    langEn: 'English',
    stampPrefixBurgundy: '时光流转',
    stampPrefixObsidian: '这是我们并肩走过的',
    stampPrefixTeal: '为您保驾护航的',
    stampPost: '已默默陪伴您 · 感谢信任',
    // Expense screen (记账)
    billDate: '账单日期',
    physicalCount: '实盘录入',
    cardBalance: '卡余额',
  ...
  'zh-TW': {
    ...
    langTw: '繁體中文',
    langEn: 'English',
    stampPrefixBurgundy: '時光流轉',
    stampPrefixObsidian: '這是我們並肩走過的',
    stampPrefixTeal: '為您保駕護航的',
    stampPost: '已默默陪伴您 · 感謝信任',
    back: '返回',
    chooseImage: '選擇圖片',
    resetDefault: '恢復默認',
    // Expense screen
  ...
  en: {
    ...
    langTw: '繁體中文',
    langEn: 'English',
    stampPrefixBurgundy: 'Time flows',
    stampPrefixObsidian: 'Side by side for',
    stampPrefixTeal: 'Guarding your journey for',
    stampPost: 'Grateful for your trust · always by your side',
    // Expense screen
    back: 'Back',
